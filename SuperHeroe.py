...
while running:
    ...
    if keys[pygame.K_LEFT] and player.left > 10: # Si pongo 0 tocará el borde
        player.x -= 5
    if keys[pygame.K_RIGHT] and player.right < WIDTH - 10: # Si pongo 0 tocará el borde
        player.x += 5

    if keys[pygame.K_UP] and player.top > 10: # Si pongo 0 tocará el borde
        player.y -= 5
    if keys[pygame.K_DOWN] and player.bottom < HEIGHT - 10: # Si pongo 0 tocará el borde
        player.y += 5
